...
export function mapEstablishmentDetail(
  ...
  return {
    ...
    delinquency: dto.revenue.delinquency,
    delinquencyAmount: dto.revenue.delinquencyAmount,
    services: dto.catalog.services,
    products: dto.catalog.products,
    campaigns: dto.catalog.campaigns,
    sessions: dto.engagement.sessions,
    dau: dto.engagement.dau,
    wau: dto.engagement.wau,
    mau: dto.engagement.mau,
    activeDays: dto.engagement.activeDays,
    utilization: dto.utilization,
    churnRisk: dto.churnRisk,
    mrrAtRisk: dto.mrrAtRisk,
    churnReasons: dto.churnReasons,
    lastAccess: dto.lastAccess ? formatDateTime(dto.lastAccess) : "—",
